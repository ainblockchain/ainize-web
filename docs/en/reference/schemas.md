...
Reusable shapes from the node’s [OpenAPI document](/api/openapi.json). Required fields are marked below. Consult OpenAPI for nested constraints, formats and unions.

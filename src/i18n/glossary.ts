...
export const GLOSSARY = {
  ...
  node: { ko: '노드', en: 'node', tech: 'P2P marketplace peer (ngram node)', help_ko: '지식을 팔고, 검증하고, 모델에 끼워 쓰는 참여자 서버입니다. 사용자는 노드를 몰라도 지식을 사서 쓸 수 있습니다.', help_en: 'A participant server that sells, verifies and applies knowledge. You can buy and use knowledge without running one.' },
